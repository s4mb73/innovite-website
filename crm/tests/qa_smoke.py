...
try:
    ...
    expected = {
        ...
        'outreach', 'inbox', 'reports', 'settings', 'mailboxes', 'healthz',
...
renders = [
    ...
    ('inbox.html',        {'active':'inbox','tab':'needs_you',
                            ...
                            'db_error':None}),
    ('mailboxes.html',    {'active':'mailboxes',
                            'summary':{'total':18,'healthy':14,'warming':3,
                                       'needs_attention':1,'paused':0,
                                       'total_capacity':500,'total_sent_today':220},
                            'domains':[
                                {'id':1,'domain':'innovite-mail.com',
                                 'dns_verified':True,'spf_verified':True,
                                 'dkim_verified':True,'dmarc_verified':True,
                                 'mailbox_count':5,'healthy_count':4,
                                 'warming_count':1,'needs_attention_count':0,
                                 'paused_count':0},
                                {'id':2,'domain':'innovitegroup.com',
                                 'dns_verified':True,'spf_verified':True,
                                 'dkim_verified':True,'dmarc_verified':False,
                                 'mailbox_count':5,'healthy_count':3,
                                 'warming_count':0,'needs_attention_count':1,
                                 'paused_count':1},
                            ],
                            'mailboxes':[
                                {'id':1,'address':'sammy@innovite-mail.com',
                                 'domain':'innovite-mail.com',
                                 'dedicated_client_id':None,'dedicated_client_name':None,
                                 'sent_today':18,'daily_cap':40,
                                 'warmup_provider':'Lemwarm','warmup_day':60,
                                 'warmup_target':50,'warmup_status':'complete',
                                 'health_state':'healthy','last_error':None,
                                 'last_error_at':None,'paused':False,
                                 'dns_verified':True,'spf_verified':True,
                                 'dkim_verified':True,'dmarc_verified':True},
                                {'id':2,'address':'louis@innovite-mail.com',
                                 'domain':'innovite-mail.com',
                                 'dedicated_client_id':1,'dedicated_client_name':'ROCA Accountants',
                                 'sent_today':42,'daily_cap':50,
                                 'warmup_provider':'Lemwarm','warmup_day':60,
                                 'warmup_target':50,'warmup_status':'complete',
                                 'health_state':'healthy','last_error':None,
                                 'last_error_at':None,'paused':False,
                                 'dns_verified':True,'spf_verified':True,
                                 'dkim_verified':True,'dmarc_verified':True},
                                {'id':3,'address':'team@innovitegroup.com',
                                 'domain':'innovitegroup.com',
                                 'dedicated_client_id':None,'dedicated_client_name':None,
                                 'sent_today':0,'daily_cap':25,
                                 'warmup_provider':'Lemwarm','warmup_day':35,
                                 'warmup_target':50,'warmup_status':'complete',
                                 'health_state':'throttled',
                                 'last_error':'Bounce rate 4.2% — auto-paused for 24h',
                                 'last_error_at':now(),'paused':False,
                                 'dns_verified':True,'spf_verified':True,
                                 'dkim_verified':True,'dmarc_verified':False},
                            ],
                            'db_error':None}),
